...
export class ProductComponent implements OnInit {
  constructor(
    ...
    this.columnDefs = [
      ...
      { field: 'title', headerName: 'Tiêu đề', sortable: true, filter: true, minWidth: 100 },
      { field: 'price', headerName: 'Giá', sortable: true, filter: true, minWidth: 100 },
      { field: 'soLuong', headerName: 'Số lượng', sortable: true, filter: true, minWidth: 100 },
